...
void main() {
  ...
  group('CountdownOverlay', () {
    ...
    testWithGame<FlameGame>('stays mounted during countdown', FlameGame.new, (
      game,
    ) async {
      final overlay = CountdownOverlay();
      await game.ensureAdd(overlay);
    ...
    testWithGame<FlameGame>('stays mounted during GO phase', FlameGame.new, (
      game,
    ) async {
      final overlay = CountdownOverlay();
      await game.ensureAdd(overlay);
    ...
    testWithGame<FlameGame>(
      ...
      (game) async {
        ...
        final totalDuration =
            GameConfig.countdownReadyDuration + GameConfig.countdownGoDuration;
