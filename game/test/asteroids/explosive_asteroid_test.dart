...
import 'package:asteroids_neon/asteroids/explosive_asteroid.dart';
...
void main() {
  ...
  group('ExplosiveAsteroid', () {
    ...
    test('has center anchor', () {
      final asteroid = ExplosiveAsteroid(asteroidSize: AsteroidSize.medium);
      expect(asteroid.anchor, Anchor.center);
    });

    test('setVelocity updates velocity', () {
      final asteroid = ExplosiveAsteroid(asteroidSize: AsteroidSize.large);
      asteroid.setVelocity(Vector2(42, 17));
      // Velocity is private, but we can verify via movement in update
    ...
    testWithGame<FlameGame>(
      ...
      FlameGame.new,
      (game) async {
        final asteroid1 = ExplosiveAsteroid(asteroidSize: AsteroidSize.large)
          ..position = Vector2(200, 200);
        ...
        final asteroid2 = ExplosiveAsteroid(asteroidSize: AsteroidSize.large)
          ..position = Vector2(200, 200);
